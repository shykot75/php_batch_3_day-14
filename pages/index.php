        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header bg-info">String Word Count</div>
                        ...
                        <div class="card-body bg-secondary">
                            <form action="action.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="string" class="form-control" value="<?php echo isset($result['string']) ? $result['string'] : ''; ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="submit" name="btn" class="btn btn-outline-info " value="Submit"/>
                                     </div>
                                </div>
